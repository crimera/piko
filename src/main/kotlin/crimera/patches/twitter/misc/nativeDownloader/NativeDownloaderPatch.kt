...
@Patch(
    ...
    description = "",
    dependencies = [SettingsPatch::class, NativeDownloaderResourcePatch::class, NativeDownloaderHooksPatch::class],
...
object NativeDownloaderPatch : BytecodePatch(
    ...
    override fun execute(context: BytecodeContext) {
        ...
        val result2 = NativeDownloaderAlwaysIcon.result ?: throw PatchException("DebugMenuFingerprint not found")
        ...
        result2.scanResult.stringsScanResult!!.matches.forEach { match ->
            ...
            if (str.contains("View in Tweet Sandbox")) {
                val loc = match.index
                val r = method2.getInstruction<OneRegisterInstruction>(loc).registerA
        ...
        val r = method3.getInstruction<OneRegisterInstruction>(loc).registerA
