...
private val HIDDEN_ID_TO_ENUM_NAMES =
    mapOf(
        ...
        "ViewPostInteractions" to listOf("ViewPostInteractions"),
        "ViewModeratedTweets" to listOf("ViewModeratedTweets"),
            ...
            newXMultiChoice(
                ...
                options =
                    listOf(
                        ...
                        choice("ViewPostInteractions", "piko_newx_post_option_view_interactions"),
                        choice("ViewModeratedTweets", "piko_newx_post_option_view_hidden_replies"),
