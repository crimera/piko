...
private val inlineActionViewTextFingerprint =
    fingerprint {
        returns("V")
        parameters("Ljava/lang/String;", "Z")
        custom { _, classDef ->
            classDef.type == "Lcom/twitter/ui/tweet/inlineactions/InlineActionView;"
        }
    }

private val tweetTweetStatViewTextFingerprint =
    fingerprint {
        returns("V")
        parameters("Lcom/twitter/ui/tweet/TweetStatView;", "Ljava/lang/String;", "Ljava/lang/String;")
        custom { _, classDef ->
            classDef.contains("Lcom/twitter/ui/tweet/")
        }
    }
