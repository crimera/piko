...
internal val customiseProfileTabsFingerprint = fingerprint {
...
@Suppress("unused")
val customiseProfileTabsPatch = bytecodePatch(
    name = "Customize profile tabs",
) {
    dependsOn(settingsPatch)
    compatibleWith("com.twitter.android")

    val results by customiseProfileTabsFingerprint()
    ...
    execute {
        ...
        settingsStatusMatch.enableSettings("profileTabCustomisation")
    }
}
