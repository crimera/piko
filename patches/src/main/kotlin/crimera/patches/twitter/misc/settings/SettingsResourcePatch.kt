...
val settingsResourcePatch = resourcePatch {
    ...
    execute { context ->
            ...
            context.document["res/xml/settings_root.xml"].use { editor ->
            ...
            context.document["res/layout/main_activity_app_bar.xml"].use { editor ->
                val parent = editor.getElementsByTagName("FrameLayout").item(1) as Element

                val sideBtn = editor.createElement("app.revanced.integrations.twitter.settings.PikoSettingsButton")
