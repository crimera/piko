...
class SettingsContributionPatchTest {
    ...
    fun `setting read fails when every compatible register is excluded`() {
        ...
        assertContains(exception.message.orEmpty(), "register available for X-Lite setting read")
    ...
    private companion object {
        val toggle =
            ToggleSettingDefinition(
                id = "xlite.test.toggle",
                titleResourceName = "piko_xlite_test_toggle_title",
        ...
        val textInput =
            TextInputSettingDefinition(
                id = "xlite.test.text_input",
                titleResourceName = "piko_xlite_test_text_input_title",
                summaryResourceName = null,
                order = 0,
                defaultValue = "",
            )
        ...
        val multiChoice =
            MultiChoiceSettingDefinition(
                id = "xlite.test.multi_choice",
                titleResourceName = "piko_xlite_test_multi_choice_title",
                summaryResourceName = null,
                order = 0,
