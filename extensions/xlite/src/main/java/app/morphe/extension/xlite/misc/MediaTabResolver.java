...
/**
 * Resolves the default sub-tab for the X-Lite combined profile media tab
 * (Photos | Videos).
 *
...
public final class MediaTabResolver {
    private static final String DEFAULT_SETTING = "xlite.post_actions_media.media_tab_default";
    ...
    public static Object getEnumDefault(Object current) {
        ...
        try {
            ...
            Logger.printException(() -> "Failed to resolve X-Lite media tab default", exception);
        }
        return current;
    }
}
