...
/** Shared reflection support for custom X-Lite post-menu options. */
public final class XLitePostOptions {
    private XLitePostOptions() {
    }
    ...
    public static List<?> addOption(List<?> groups, String optionName, boolean enabled) {
        ...
        try {
            ...
            Logger.printException(() -> "Failed to add X-Lite post-menu option " + optionName, exception);
            return groups;
        }
    }
