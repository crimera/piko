...
public final class DynamicColorPalette {
    ...
    private static final String DYNAMIC_LIKE_SETTING = "xlite.theme.dynamic_like";
    ...
    private static long accentTone(int tone, long originalColor) {
        ...
        String resourceName = switch (tone) {
            ...
            default -> throw new IllegalArgumentException(
                    "Unknown X-Lite dynamic accent tone: " + tone
            );
        };
    ...
    private static long paletteColor(
        ...
        return switch (token) {
            ...
            default -> throw new IllegalArgumentException("Unknown X-Lite dynamic color token: " + token);
        };
    }
    ...
    private static int requiredColor(String resourceName) {
        ...
        if (resourceId == 0) {
            throw new IllegalStateException(
                    "X-Lite dynamic color resource is missing on Android 12+: " + resourceName
            );
        }
    ...
    private static void requireSupported() {
        ...
        throw new IllegalStateException("X-Lite dynamic color requires Android 12 or newer");
    }
}
