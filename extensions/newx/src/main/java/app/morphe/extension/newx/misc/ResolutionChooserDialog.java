...
public final class ResolutionChooserDialog {
    ...
    public static void show(
        ...
        dialog.setTitle(isImage(item) ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_resolution_title") : app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_quality_title"));
        ...
        for (InlineDownloadButton.DownloadItem option : item.resolutionOptions) {
            ...
            row.setTitle(("Original".equals(option.label) ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_inline_download_quality_original") : ("Large".equals(option.label) ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_inline_download_quality_large") : ("Medium".equals(option.label) ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_inline_download_quality_medium") : ("Small".equals(option.label) ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_inline_download_quality_small") : option.label)))));
    ...
    private static String subtitleFor(
        ...
        if (username != null && !username.trim().isEmpty()) {
            builder.append(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_media_author", username.trim()));
        }
