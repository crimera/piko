...
final class NewXPreferenceStyle {
    private enum TrailingAccessory {
        NONE,
        SWITCH,
    }

    private static final String TAG_LEADING = "piko_newx_pref_leading";
    private static final String TAG_TITLE = "piko_newx_pref_title";
    private static final String TAG_SUMMARY = "piko_newx_pref_summary";
    private static final String TAG_SWITCH = "piko_newx_pref_switch";
    private static final int[] TITLE_TEXT_SIZES = {13, 14, 15, 16, 17, 18};
    private static final int[] SUMMARY_TEXT_SIZES = {12, 13, 14, 15, 16, 17};

    private NewXPreferenceStyle() {
    }
    ...
    private static View createRow(
        ...
        if (trailingAccessory == TrailingAccessory.SWITCH) {
            NewXSettingsUi.SwitchControl switchView =
                    new NewXSettingsUi.SwitchControl(context);
    ...
    static final class Toggle extends SwitchPreference {
        private NewXSettingsUi.SwitchControl switchView;
