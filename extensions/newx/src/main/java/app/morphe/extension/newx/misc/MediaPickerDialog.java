...
public final class MediaPickerDialog {
    ...
    public static void show(
        ...
        dialog.setTitle(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_download_media_title"));

        String defaultSubtitle = (username != null && !username.trim().isEmpty())
                ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_media_author", username.trim())
                : app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_select_media_hint");
        ...
        if (canMerge) {
            mergeButton = new ButtonView(
                    ...
                    app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_download_merge")
            );
        ...
        final ButtonView downloadButton = new ButtonView(
                ...
                hasMultiple ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_download_all", downloads.size()) : app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_download_one")
        );
        if (!hasMultiple) {
        ...
        updateUiHolder[0] = () -> {
            ...
            if (isSelectionMode[0]) {
                dialog.setTitle(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_select_media_title"));
                dialog.setSubtitle(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_media_selected", selectedCount, downloads.size()));
                downloadButton.setEnabled(true);
                if (selectedCount == downloads.size()) {
                    downloadButton.setText(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_download_all", downloads.size()));
                } else {
                    downloadButton.setText(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_download_selected", selectedCount));
                }
                downloadButton.setVisibility(View.VISIBLE);

                if (mergeButton != null) {
                    if (selectedImageCount >= 2) {
                        mergeButton.setText(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_merge_selected", selectedImageCount));
                ...
                if (mergeButton != null) {
                    mergeButton.setText(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_download_merge"));
                    mergeButton.setVisibility(View.VISIBLE);
                    mergeButton.setEnabled(true);
                }
            }
        ...
        for (int i = 0; i < downloads.size(); i++) {
            ...
            itemRow.setTitle(("Image".equals(item.label) ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_label_image") : "Video".equals(item.label) ? app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_label_video") : item.label) + (hasMultiple ? " " + (i + 1) : ""));
        ...
        if (showCopyLinkButton) {
            itemRow.addTrailingIconButton(
                    ...
                    v -> {
                        ...
                        Utils.showToastShort(app.morphe.extension.newx.settings.NewXStrings.str("piko_newx_ui_link_copied"));
                    }
            );
        }
    }
