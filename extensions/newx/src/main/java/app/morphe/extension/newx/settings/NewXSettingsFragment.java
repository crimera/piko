...
public final class NewXSettingsFragment extends PreferenceFragment {
    ...
    static NewXSettingsFragment forGroup(SettingsNode.Group group) {
        NewXSettingsFragment fragment = new NewXSettingsFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Context preferenceContext = NewXSettingsActivity.createPreferenceContext(activity);
    ...
    private void openGroup(SettingsNode.Group group) {
        ...
        int containerId = NewXSettingsActivity.SETTINGS_CONTAINER_ID;
        getFragmentManager()
                .beginTransaction()
    ...
    private void openScreen(SettingsNode.CustomScreen screen) {
        ...
        try {
            ...
            throw new IllegalStateException("Could not open NewX custom screen: " + screen.id, exception);
        }
    }
    ...
    private Activity requireActivity() {
        Activity activity = getActivity();
        if (activity == null) throw new IllegalStateException("NewX settings activity is missing");
        return activity;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        int backgroundColor = NewXPreferenceStyle.backgroundColor(root.getContext());
