...
public class UI {
    ...
    public static final String DRAWABLE_TEXT_ICON = "instagram_text_pano_filled_24";
    public static final String DRAWABLE_CHECK_ICON = "instagram_check_pano_filled_24";
