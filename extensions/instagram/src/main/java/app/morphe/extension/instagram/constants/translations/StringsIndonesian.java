...
public class StringsIndonesian extends DefaultStrings {
	public StringsIndonesian() {
		...
		this.CUSTOMISE_STORY_RING_SIZE = "Sesuaikan ukuran lingkaran cerita";
		this.CUSTOMISE_STORY_RING_SIZE_DESC = "Ubah ukuran lingkaran cerita berdasarkan persentase (Nilai bawaan: 100)";
