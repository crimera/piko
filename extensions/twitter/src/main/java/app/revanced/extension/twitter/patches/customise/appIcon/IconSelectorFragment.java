...
public class IconSelectorFragment extends Fragment {
    ...
    private List<IconSection> getIconSections() {
        ...
        category_sports.add(new IconOption(StringRef.str("piko_app_icon_name_ncaa"), Utils.getResourceIdentifier("ic_seasonal_ncaa", "mipmap"), "app.revanced.extension.twitter.appicon16"));
