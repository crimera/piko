## [1.28.0](https://github.com/riolove1/piko/compare/v1.27.1...v1.28.0) (2025-10-11)

### Bug Fixes

* Add back settings for the custom sharemenu buttons ([bc7e777](https://github.com/riolove1/piko/commit/bc7e777e59091801238d4692823415b0d7d2855b))
* Add support for 10.83.0 releases ([9344d52](https://github.com/riolove1/piko/commit/9344d527d1ec5e0fd812bd835c45304a6619df95))
* Adding debug menu patch results in a crash ([caf82eb](https://github.com/riolove1/piko/commit/caf82ebd95bd113dbd5cacda1deffa9194cb280b))
* **Bring back twitter:** Change the character "𝕏" into "Twitter". ([#441](https://github.com/riolove1/piko/issues/441)) ([c20e16f](https://github.com/riolove1/piko/commit/c20e16f80499df75176e9080f156e529f4f7d326))
* **Bring back twitter:** Change x icon to legacy twitter. ([3006f47](https://github.com/riolove1/piko/commit/3006f47d973ffde1622ae1544590a11e923c68ab))
* **Bring back twitter:** Resource compilation fails on ReVanced Manager ([a364bec](https://github.com/riolove1/piko/commit/a364becc7f6f70724c37b9499e79885fb09f0436))
* **Custom download folder:** Restore compatibility with versions prior to 10.64 ([b88b00b](https://github.com/riolove1/piko/commit/b88b00ba97632d62517c0e52a924c453ea022d7a))
* **Custom downloader:** Improve fingerprint ([2a2a4a4](https://github.com/riolove1/piko/commit/2a2a4a4e2cdc6587c5c3b91bb3888918d7cd720d))
* **Enable Reader Mode:** Specify the compatible version, show a warning instead of throwing an exception when failed ([b1c52e7](https://github.com/riolove1/piko/commit/b1c52e73daabe3222e925ba5d6b866af31a35045))
* **Feature Flags:** Use ListView instead of RecyclerView for a more reliable list. ([6f16b7f](https://github.com/riolove1/piko/commit/6f16b7f7d61c81e7a21394f74b6e0d0e80ed9a55))
* Fix crash when opening feature flags ([2b1484d](https://github.com/riolove1/piko/commit/2b1484d6c291a997283d98358cff98b0195acfed))
* Improve getUsername fingerprint ([af617af](https://github.com/riolove1/piko/commit/af617af523bfa7df00a232a51364ea9e8ea4d34f))
* Remove debug prints ([33e4d08](https://github.com/riolove1/piko/commit/33e4d08a58451217781914953c1ffb711ea8480b))
* **Remove Detailed posts:** Change the settings label from "detailed" to "related" ([3cf5f9e](https://github.com/riolove1/piko/commit/3cf5f9ec9e383deb17919f2b3c5254954502c825))
* Remove duplicate strings ([94c6642](https://github.com/riolove1/piko/commit/94c66422e0ced2cbdfd820dfee60cedd2c68e636))
* **Remove Google Ad:** Include ads in the comments ([79d6e35](https://github.com/riolove1/piko/commit/79d6e35144ffc6c81d3bb36499fc2c22e5a089ac))
* Remove obsolete `Open browser chooser on opening links` patch ([a1e2b76](https://github.com/riolove1/piko/commit/a1e2b766a872c3ee2facef1444bfa92ab4236144))
* Resource strings getting corrupted, resulting on failure to patch on revanced manager ([#439](https://github.com/riolove1/piko/issues/439)) ([1763137](https://github.com/riolove1/piko/commit/1763137126b9a95df51fe23ce816853ccf0a8f44))
* **Translations:** Fix unescaped strings in fr and vi ([be94c4c](https://github.com/riolove1/piko/commit/be94c4c3b6785a1f9ecfdc1dbad48a4a9885a539))
* tweet highlight color on hold ([#243](https://github.com/riolove1/piko/issues/243)) ([b22ea42](https://github.com/riolove1/piko/commit/b22ea426830b250abaa336e3b158dea34f82f6d6))
* **Twitter - copy media link + Custom download folder:** Update fingerprint to work on latest twitter release ([cc8fadb](https://github.com/riolove1/piko/commit/cc8fadbac2d31139ae8b9572dd1aeb2565564e75))
* **Twitter - Custom Downloader:** Added VideoDataClass Fingerprint ([99ff271](https://github.com/riolove1/piko/commit/99ff271b3fcbf1a6f3666b97c256528435f6501c))
* **Twitter - Custom Downloader:** Improve fingerprints ([f962310](https://github.com/riolove1/piko/commit/f9623106106bd21b9b595983e8db244c8c35e227))
* **Twitter - Log server response:** Escape single qoutes ([cedbfaf](https://github.com/riolove1/piko/commit/cedbfaf77913afb81b0363207a9839ea1624fa63))
* **Twitter:** `Customize Navigation Bar items` in/from `10.53.0-beta.1` ([e8154fb](https://github.com/riolove1/piko/commit/e8154fb0ffa91e6d3ed2812bed3f71a034f3bc01))
* **Twitter:** `Hide community badges` patch ([f539260](https://github.com/riolove1/piko/commit/f5392600b3e51a3c32fa3ffb4da5d751da3b8612))
* **Twitter:** Add support for version 10.64.0-beta.1 ([c81378d](https://github.com/riolove1/piko/commit/c81378d80275465acbf9caed5f48235b56395d56))
* **Twitter:** Change patch name from `Enable app icon settings` -> `Enable app icons` ([5a7ef46](https://github.com/riolove1/piko/commit/5a7ef469557e5cf4ecc9ce8465d73c20501dc524))
* **Twitter:** fix `Control video auto scroll` in 10.57 ([b7ae78c](https://github.com/riolove1/piko/commit/b7ae78cd61b2f75d266e3fe3d57c5c21cd798e79))
* **Twitter:** fix `Custom downloader` patch ([f4d953a](https://github.com/riolove1/piko/commit/f4d953a3dc7cb8325e56e515cd38a8ab707d2162))
* **Twitter:** fix `Custom translator` patch ([8065fa3](https://github.com/riolove1/piko/commit/8065fa32019d1d1bd4c9bd116f1774e345203356))
* **Twitter:** Fix `Customize profile tabs` crash after `10.43` ([a38d621](https://github.com/riolove1/piko/commit/a38d6213e06404fde21f6b5b8eddfcdfe8edd73e))
* **Twitter:** Fix `Customize side bar items` patch ([4664f02](https://github.com/riolove1/piko/commit/4664f02c065396dc28406fe5b47478eff6b6c4aa))
* **Twitter:** fix `Enable app icon settings` patch ([c2b6f79](https://github.com/riolove1/piko/commit/c2b6f79b5c833c2441432b2511374361318e5507))
* **Twitter:** fix `Enable debug menu for posts` patch ([72a72f2](https://github.com/riolove1/piko/commit/72a72f2114d0ee9fe2cac0e5eae5b03e196dd6e2))
* **Twitter:** fix `Enable force HD videos` patch ([6d8d200](https://github.com/riolove1/piko/commit/6d8d200a521375252c675117365e1fb85f701083))
* **Twitter:** Fix `Enable Undo Posts` patch ([883b6cb](https://github.com/riolove1/piko/commit/883b6cb92c52d1a475f6663bdf474518280b4da4))
* **Twitter:** Fix `Hide nudge button` patch ([87ceb49](https://github.com/riolove1/piko/commit/87ceb49f841c99012fcbbc315edc1c4657376e37))
* **Twitter:** Fix `Hide nudge button` patch ([d7572fe](https://github.com/riolove1/piko/commit/d7572feac66d44f0fe669073ee09bc09637adb9a))
* **Twitter:** fix `Hide nudge button` patch (again) ([be2cd9d](https://github.com/riolove1/piko/commit/be2cd9de0aa2545274369ed0c724ffead77148ee))
* **Twitter:** Fix `Remove premium upsell` patch ([4df5e32](https://github.com/riolove1/piko/commit/4df5e32088eb57702c5f30e20b3c75d2ec11ee87))
* **Twitter:** fix `Remove videos for you` patch ([b19f943](https://github.com/riolove1/piko/commit/b19f943ee8a19ea158e89cc031ae037e43da6e50))
* **Twitter:** Fix aapt breakage due to tag mismatch ([730a51c](https://github.com/riolove1/piko/commit/730a51c20f464bbe2b680004721161dd5f34dadf))
* **Twitter:** Fix App icon error toast ([2997b56](https://github.com/riolove1/piko/commit/2997b56f13c37681acbf89efcbd12647ee1c5056))
* **Twitter:** Fix Settings crash ([015c5bd](https://github.com/riolove1/piko/commit/015c5bdd1247ec6263fa194ca6e580690e13e223))
* **Twitter:** Fix share menu patches ([ba561be](https://github.com/riolove1/piko/commit/ba561be67cf5d854cfff477a3a80b85928a4170a))
* **Twitter:** Fix unescaped characters ([829eedd](https://github.com/riolove1/piko/commit/829eedd90eabc13575b49da9cc5551f894787b76))
* **Twitter:** fix video entity hook in `10.58` ([e8a833d](https://github.com/riolove1/piko/commit/e8a833d2123b92a40caf68b4f6798e822a6d1737))
* **Twitter:** Missing download option in immersive view ([6b0aa2c](https://github.com/riolove1/piko/commit/6b0aa2c0d8d0f9192630e42abef418a834a95df0))
* **Twitter:** Share menu button add hook in/from 10.67 ([a640946](https://github.com/riolove1/piko/commit/a640946e7045be359535ed0eead00ec80d2e10c4))
* **ui:** adjust monet-light colors to have a white background ([0906e93](https://github.com/riolove1/piko/commit/0906e93027747e43becd1d94bca24f54ecc97683))
* Unescaped apostrophe ([487e992](https://github.com/riolove1/piko/commit/487e99259b772cbf44f09028807db223f464df85))
* URL decode path to JAR containing spaces by osumatrix ([e6671ba](https://github.com/riolove1/piko/commit/e6671ba4a8359db7aefa1ab20600e1f17144e002))
* Use UrlDecoder API available in older Android versions ([d9e6374](https://github.com/riolove1/piko/commit/d9e63740b7eb7c8a4f44abf6d59998ea14194346))

### Features

* **all:** Added `Export all activities` patch from ReVanced ([7cc405f](https://github.com/riolove1/piko/commit/7cc405f7e900b85aaa172e8693cd4ca2e790451d))
* **Bring back twitter:** Add Japanese ([4eb08b5](https://github.com/riolove1/piko/commit/4eb08b554eaf92958e0e159647fc71b35340e2b2))
* **Customize side bar items:** Allow for hiding of the "Jobs" item ([14ce811](https://github.com/riolove1/piko/commit/14ce811a7b4d885fa6779524aad0b41034a2d8d0))
* Enable recent patches by default ([e84f358](https://github.com/riolove1/piko/commit/e84f358e494830fdecdc3dd12662b5f5ccd644b3))
* **Hook feature flag:** Added ability to search for supported flags. ([28a2c0a](https://github.com/riolove1/piko/commit/28a2c0a6ca97fa50711ce44cfa1f20b5147e906f))
* Quick settings button is now optional ([e9e54e5](https://github.com/riolove1/piko/commit/e9e54e5e44437b92db9700c363f0abd9117cc325))
* Remove throw file ([86bff99](https://github.com/riolove1/piko/commit/86bff993636928c67ca95dabeebcf1f5cc191a36))
* **Settings:** Add a description to "Native features" page ([be7aa54](https://github.com/riolove1/piko/commit/be7aa5472c9b12ff6207992b21292b4fb4d337cf))
* **Translations:** Add italian translation ([88e22fb](https://github.com/riolove1/piko/commit/88e22fbb64eae5b2b185c0c785d75a29bb342458))
* **Translations:** French translation added ([a6f650c](https://github.com/riolove1/piko/commit/a6f650c3cbea3b3964fc4b58962067e16609a848))
* **Translations:** Korean translation added ([492e631](https://github.com/riolove1/piko/commit/492e6312df05d3bdae618e350a929a8b22914c98))
* **Translations:** Update `japanese` ([444623f](https://github.com/riolove1/piko/commit/444623faaa5761b33445705e04e5c3078ff88124))
* **Translations:** Update `Japanese` ([80282f0](https://github.com/riolove1/piko/commit/80282f0e4eb3b6f1cde7eb6e30f7d00ba9b26a0c))
* **Translations:** Update `Japanese` ([a7da7d7](https://github.com/riolove1/piko/commit/a7da7d7468203a3244496b4ed692a8d09da18b45))
* **Translations:** Update `Japanese` ([039aac3](https://github.com/riolove1/piko/commit/039aac304215858769c794684f837719edad9790))
* **Translations:** Update `Polish` ([97b3790](https://github.com/riolove1/piko/commit/97b379029deba1044436cb5a983335b515e7f959))
* **Translations:** Update `Polish` ([e49393e](https://github.com/riolove1/piko/commit/e49393eefe75118c29575324f5832c7cc3589530))
* **Translations:** Update `Polish` ([d81f93c](https://github.com/riolove1/piko/commit/d81f93cff2c31c9fe82ff8e43598ab90e6d899ab))
* **Translations:** Updated Traditional Chinese string-zh-rCN.xml ([6cc2373](https://github.com/riolove1/piko/commit/6cc2373e417a1ed386a2682f970662e367033b43))
* **Translations:** Updated Traditional Chinese string-zh-rTW.xml ([6787c28](https://github.com/riolove1/piko/commit/6787c28318762382d73f1eb8c6ad9abc4b2ee2e6))
* **Twitter:** Added 'Native reader mode'  patch ([308e1e6](https://github.com/riolove1/piko/commit/308e1e6ae392eb6c0b9ade6383957fd2983e68f5))
* **Twitter:** Added `Control video auto scroll` patch ([7a21924](https://github.com/riolove1/piko/commit/7a21924dc7f30a15feef1797b0416c91de27d1e4))
* **Twitter:** Added `Custom downloader` ([3d5941e](https://github.com/riolove1/piko/commit/3d5941e226c1fb9402edeeb138c1c974026e0598))
* **Twitter:** Added `Custom translator` patch ([737fb9e](https://github.com/riolove1/piko/commit/737fb9eaa0b8da7f020b93c314f5da60f961e345))
* **Twitter:** Added `Customise post font size` patch ([ea608e0](https://github.com/riolove1/piko/commit/ea608e09b7b0775f38ca1914503e1b54dc7b73f9))
* **Twitter:** Added `Customize explore tabs` patch ([4be6a7f](https://github.com/riolove1/piko/commit/4be6a7fe6ace42ca299d2e4bc7f9a963774f3bcd))
* **Twitter:** Added `Customize Inline action Bar items` patch ([05b06f9](https://github.com/riolove1/piko/commit/05b06f9fa4a183c9626acc7fda69c0bebdbae761))
* **Twitter:** Added `Customize Navigation Bar items` patch ([9c6f59c](https://github.com/riolove1/piko/commit/9c6f59cf6f40cc4d4d61b13bf496f800f452c0c1))
* **Twitter:** Added `Customize reply sort filter` patch ([121b8a6](https://github.com/riolove1/piko/commit/121b8a6e9345ea462ad9cb06f7b20f863fc08d4a))
* **Twitter:** Added `Customize search suggestions` patch ([aaca565](https://github.com/riolove1/piko/commit/aaca565c650d6cf4b2cbb8abf2e206efe9983cb1))
* **Twitter:** Added `Customize search tab items` patch ([9edc97a](https://github.com/riolove1/piko/commit/9edc97a89e61f28a5cd9a419d167a6c51a1a9816))
* **Twitter:** Added `Customize side bar items` patch ([ca0d28f](https://github.com/riolove1/piko/commit/ca0d28f96d65d7d7f300f6089029ec24e55802b4))
* **Twitter:** Added `Debug Menu` patch ([7d5ca77](https://github.com/riolove1/piko/commit/7d5ca77bf633a8dfcd8657d12b24bd076b2f5d11))
* **Twitter:** Added `Delete from database` patch ([d785660](https://github.com/riolove1/piko/commit/d7856602786d3fb9d7a8721f05d80be97bc4fd3b))
* **Twitter:** Added `Disable auto timeline scroll on launch` patch ([b8d431e](https://github.com/riolove1/piko/commit/b8d431ea44a2b53f9065c226116d86ec1fb7b70f))
* **Twitter:** Added `Enable force HD videos` patch ([d316612](https://github.com/riolove1/piko/commit/d3166121ac39adf45440e6888b43487e398f61e6))
* **Twitter:** Added `Enable PiP mode automatically` patch ([59d6b67](https://github.com/riolove1/piko/commit/59d6b6723cbff6fa96218fb6210e2cb0b8bc1338))
* **Twitter:** Added `Hide Buy Premium Banner` patch ([7ba6419](https://github.com/riolove1/piko/commit/7ba64198f289ffac2e3d397e5bf0f1137ba2aa2b))
* **Twitter:** Added `Hide community badges` patch ([57936a1](https://github.com/riolove1/piko/commit/57936a167eb23eeb992ca39015149e71e04270c5))
* **Twitter:** Added `Hide followed by context` patch ([261e1d0](https://github.com/riolove1/piko/commit/261e1d0156702a4a72105b430d50e59e88795198))
* **Twitter:** Added `Hide hidden replies` patch ([431acc4](https://github.com/riolove1/piko/commit/431acc435675002c7d9f068b4fc3ebade2487db3))
* **Twitter:** Added `Hide nudge button` patch ([ad27484](https://github.com/riolove1/piko/commit/ad27484f4cc0d727cf07cb4f202c8ddd6b582d67))
* **Twitter:** Added `Log server response` patch ([bff4363](https://github.com/riolove1/piko/commit/bff4363a56386ec6e1c80f2a57bdc70a28827be6))
* **Twitter:** Added `Remove main event` patch ([806598d](https://github.com/riolove1/piko/commit/806598d7154c538fb238f3d9b186746cb8c956bf))
* **Twitter:** Added `Remove premium upsell` patch ([37525de](https://github.com/riolove1/piko/commit/37525de868c38254cbfd20b58d4fd077b0c14ca2))
* **Twitter:** Added `Remove Todays news` patch ([8324633](https://github.com/riolove1/piko/commit/8324633509fdf61756751fdde67e5752ff3dee5c))
* **Twitter:** Added `Remove top people in search` patch ([95b5ef9](https://github.com/riolove1/piko/commit/95b5ef902e6f595093b2304e5b2a8189f273389c))
* **Twitter:** Added `Remove videos for you` patch ([25934a2](https://github.com/riolove1/piko/commit/25934a2b58a8eefc05d4313b623580371d964a12))
* **Twitter:** Added `Round off numbers` patch ([b1c1b13](https://github.com/riolove1/piko/commit/b1c1b1361b55f08e2eba64e086943b30b2dc1212))
* **Twitter:** Added `Show post source label` patch ([931bc76](https://github.com/riolove1/piko/commit/931bc762c3fc03535bf427b3e691f09e76271c85))
* **Twitter:** Added ability to reset pref and flags ([4aaeb09](https://github.com/riolove1/piko/commit/4aaeb09ce6c38c6513be6293140a7e7e0b796f28))
* **Twitter:** Added Remember filter for `Customize reply sort filter` ([24df398](https://github.com/riolove1/piko/commit/24df3987e5008aeca52c11a8b20714766cdafff1))
* **Twitter:** Added tab redirects hook (for Bookmark Navbar) ([f01b418](https://github.com/riolove1/piko/commit/f01b418fcc13e9fe54d845eab3bea1cd62687f9f))
* **Twitter:** Custom deeplinks ([325a281](https://github.com/riolove1/piko/commit/325a281225b1379b310d8ba14629bdbae0b314e5))
* **Twitter:** support custom deeplink hosts ([499cc5e](https://github.com/riolove1/piko/commit/499cc5ea3e32d3e6d551755df2f94b7dbc3da9af))
* **ui:** app wide monet theming in light mode ([46f920b](https://github.com/riolove1/piko/commit/46f920bd35841e3df85617aed6a439f0df114d7b))

### Updates

* Add spanish to languages ([e9b8efd](https://github.com/riolove1/piko/commit/e9b8efdb3570fa516f06a736f2709d1c166df1bf))
* Enable `Customize profile tabs` patch by default ([a8543bf](https://github.com/riolove1/piko/commit/a8543bf0d2eebe8a1580870b95c75a890e845ff4))
* Enable `Hide Live Threads` patch by default ([b9862b5](https://github.com/riolove1/piko/commit/b9862b50b97741721448c0ea667769b0024961c9))
* **Hook feature flag:** Improve flag matching in search. ([d7f0827](https://github.com/riolove1/piko/commit/d7f0827218a9501a0b2e061990ce60a0af18ba0e))
* Improve adding new buttons in share menu ([16cc3bd](https://github.com/riolove1/piko/commit/16cc3bd01c03bfc800d61f0844b455c5d086422a))
* Improve quick settings appearance ([6dc27b4](https://github.com/riolove1/piko/commit/6dc27b4a888d0028e455be1e1b41b83cdd7f7940))
* Improved the hooking of the recyclerview methods. also fixes the crash when opening feature flags. ([25e5bc4](https://github.com/riolove1/piko/commit/25e5bc422c3893747b8fadd0744833a4ecb7b6ea))
* Russian translation ([42b68e9](https://github.com/riolove1/piko/commit/42b68e96fccca505a60d6eb2682cbfb7f7acfb17))
* Translation updates ([509dfbb](https://github.com/riolove1/piko/commit/509dfbb9e92511379406979a19b131a685229fc6))
* Translations ([d3ae8ec](https://github.com/riolove1/piko/commit/d3ae8ec55dced8d7d09146c224d332f72414382a))
* **Translations:** Add French & Korean to Language List ([#567](https://github.com/riolove1/piko/issues/567)) ([6e139be](https://github.com/riolove1/piko/commit/6e139be56dbc4f754c892d7c8ba2ed28ee8fa67f))
* **Translations:** New translations for `pt-br` ([850aa0d](https://github.com/riolove1/piko/commit/850aa0d17e0cd9a83a9c897be11b45784a82860a))
* **Translations:** Translation updates ([4bf8a8d](https://github.com/riolove1/piko/commit/4bf8a8dd954a7013a65ceee9d39521fd445d069d))
* **Translations:** Update `Japanese` ([c28d9c7](https://github.com/riolove1/piko/commit/c28d9c7850794cb8aede686201e5d80482c42f1e))
* **Translations:** Update `Japanese` ([b326d10](https://github.com/riolove1/piko/commit/b326d10599db407e1e922ac8d6d2694a67c6e42b))
* **Translations:** Update `Polish` ([973391d](https://github.com/riolove1/piko/commit/973391d6e0cfb1735dbc2102a419b9df783fa8f9))
* **Translations:** Update `Polish` ([#613](https://github.com/riolove1/piko/issues/613)) ([b6ea9de](https://github.com/riolove1/piko/commit/b6ea9dec045eeb5172fc1d01b1365929e127b4b0))
* **Translations:** Update Brazilian Portuguese ([8745f61](https://github.com/riolove1/piko/commit/8745f61c060a62152bd84ee510d835ac8346e01e))
* **Translations:** Update polish translations ([6200d65](https://github.com/riolove1/piko/commit/6200d657b5db4040f10ec4f82054ad440b09221c))
* **Translations:** update simplified chinese translation ([3e5a8fd](https://github.com/riolove1/piko/commit/3e5a8fdd07a7f7646e860a76fc81165b67b211bf))
* **Translations:** Update translations ([9686863](https://github.com/riolove1/piko/commit/968686390263fa700488deb5d87085470267c7cf))
* **Twitter:** Added hide 'Settings and privacy' in `Customize side bar items` ([cb01885](https://github.com/riolove1/piko/commit/cb018852c8af8caaf4b986444208ab00a39eab41))
* **Twitter:** Added strings ([fad9b1a](https://github.com/riolove1/piko/commit/fad9b1a9fd79b164c713fe35b61bad8ed3d9373b))
* **Twitter:** Change Quick Btn path ([7febdf6](https://github.com/riolove1/piko/commit/7febdf612212ba61638fd818121c8cc4b9db8ed8))
* **Twitter:** Enable new patches by default ([19f9149](https://github.com/riolove1/piko/commit/19f9149452fafae83584508fe7ae9d594fcf5543))
* **Twitter:** Updated `Enable force HD videos` patch description ([86ea041](https://github.com/riolove1/piko/commit/86ea0418d3606b6e04f8fbea8fc530aba5316f0f))
* **Twitter:** updated string ([60afc68](https://github.com/riolove1/piko/commit/60afc683c4be02ba4d5cdc92879aad2e6755b14b))
* **Twitter:** Updated strings ([3cb159e](https://github.com/riolove1/piko/commit/3cb159e57d66e22b7c2f638e5d0b7422a4ef2a10))

### Refactors

* **Custom Downloader:** Improve getting of tweet method declarations ([5237e49](https://github.com/riolove1/piko/commit/5237e496140cc94fb9beb4a72057d927527dd78b))
* **Twitter:** Added 'Native features' section ([12d2bda](https://github.com/riolove1/piko/commit/12d2bdaafd111eee81f22bdafa306c3493754c80))
* **Twitter:** Added `No shortened URL` as a settings toggle ([ea33a30](https://github.com/riolove1/piko/commit/ea33a308c277e3e40e085112e970406cee64f0cd))
* **Twitter:** Added missing patches names ([b3fda95](https://github.com/riolove1/piko/commit/b3fda9558251eda91e6e3b43e994a9dbcdb1daac))
* **Twitter:** Added Native download filename customization ([99a10b1](https://github.com/riolove1/piko/commit/99a10b1615ffa3fb72df0ad283255e9c837a012f))
* **Twitter:** Added quick settings button in side drawer ([c0152e3](https://github.com/riolove1/piko/commit/c0152e327e8b2e3fa2ad57d63c35738d4575cc98))
* **Twitter:** Added toggle for `Show sensitive media` patch ([cac4fe7](https://github.com/riolove1/piko/commit/cac4fe747640e37dc9155c63f23082c44963c05d))
* **Twitter:** Change translator icon ([bf5f027](https://github.com/riolove1/piko/commit/bf5f027f80507cf0db5b3dfd208d26b131987eca))
* **Twitter:** Changed `Top Articles ` string ([b590695](https://github.com/riolove1/piko/commit/b5906957cb8cda07a40e02008b5ad69ad6389637))
* **Twitter:** Combined `customize patch` into single class ([6c04aed](https://github.com/riolove1/piko/commit/6c04aed5ec958cb86471d94dd1729c4ad7952c8d))
* **Twitter:** consolidate native features ([79a37af](https://github.com/riolove1/piko/commit/79a37afded871a185545afcd1c6a36815ec89b41))
* **Twitter:** Force enable `Enable app icon settings` patch ([ee605f1](https://github.com/riolove1/piko/commit/ee605f11f8c95e6b8cf5d1d1cf2357593e1ea318))
* **Twitter:** Major string changes ([f22fdf0](https://github.com/riolove1/piko/commit/f22fdf086184f71447d2696461d76914dbef731d))
* **Twitter:** More strings refactor ([d5a629f](https://github.com/riolove1/piko/commit/d5a629f39bc4c15be1914a6ab98034129ed53f64))
* **Twitter:** Move redirect BM to settings patch dependancy ([4dbc491](https://github.com/riolove1/piko/commit/4dbc49198ecd3a10d288f8f7cebcbca255aaa9b7))
* **Twitter:** Moved to `models` approach ([4bc56cb](https://github.com/riolove1/piko/commit/4bc56cbb3de7147706786e186ebf7f2ea9df15a2))
* **Twitter:** refactor `Custom downloader` patch ([42cc752](https://github.com/riolove1/piko/commit/42cc752c599f978f455f84ae9a917f7bb457af98))
* **Twitter:** Refactor `Custom downloader` patch ([1e966f7](https://github.com/riolove1/piko/commit/1e966f7f519b7d947e0b516f8bc0ca0c55c1d623))
* **Twitter:** Refactor `Enable app icon settings` patch ([e7b3d0e](https://github.com/riolove1/piko/commit/e7b3d0e3bfdfb5fc7dff3564c021c04d7d2d564c))
* **Twitter:** refactor button class Hook ([2bf411a](https://github.com/riolove1/piko/commit/2bf411a61fd5181d5266d1496becf7b93f4d0d08))
* **Twitter:** Refactor hooks filename ([2daa292](https://github.com/riolove1/piko/commit/2daa2922c7225711fd1aa5d0556493e068026e0a))
* **Twitter:** refactor strings-pl ([9aacfa1](https://github.com/riolove1/piko/commit/9aacfa1baf7ed0301850f30ae8053c101ef8b27b))
* **Twitter:** refactor values of list preference ([e0e5c5b](https://github.com/riolove1/piko/commit/e0e5c5b8639efcd5eecd6476bc59b7f125d5b851))
* **Twitter:** Removed unused string from pt-BR ([cdb2067](https://github.com/riolove1/piko/commit/cdb2067360944309a9156b71bf9776457c44c49a))
* **Twitter:** renamed 'Share menu button' fingerprints to hooks ([395c221](https://github.com/riolove1/piko/commit/395c2217fc5f5b18cdc76568c3845140f76940d6))
* **Twitter:** Renamed patch `Remove Buy Premium Banner` to `Remove message prompts Banner` ([45dbad8](https://github.com/riolove1/piko/commit/45dbad85abb22e0ab74d1dd0bcd977c4aeef3349))
* **Twitter:** Separated `App icon` and `Navigation icon` patch ([8a67f12](https://github.com/riolove1/piko/commit/8a67f12e0430dbd06a6184a150ba75da832a2c54))
* **Twitter:** Seperated/Added `Remove superhero event` patch ([d60ee17](https://github.com/riolove1/piko/commit/d60ee17294b311bb964e3cc6200465218d7baca3))
* **Twitter:** Strings in 'Customization' ([c52c2c0](https://github.com/riolove1/piko/commit/c52c2c01948bdea5593636a99502d8b5c6c41dca))
* **Twitter:** Strings in 'Customization' ([a75221b](https://github.com/riolove1/piko/commit/a75221b80c1d3223b88890a95ca1610432defbe2))
* **Twitter:** Strings refactor ([2db8866](https://github.com/riolove1/piko/commit/2db88663e70745ef81024d896ad5204c29b1ba06))

### Perfomance

* **Bring back twitter:** Optimize string replacement ([#440](https://github.com/riolove1/piko/issues/440)) ([7e61023](https://github.com/riolove1/piko/commit/7e6102351d9488f89489f87df2ec45d6d0d178d8))
