## [1.31.0](https://github.com/chemchetchagio/piko/compare/v1.30.2...v1.31.0) (2025-01-26)

### Bug Fixes

* **Bring back twitter:** Change the character "𝕏" into "Twitter". ([#441](https://github.com/chemchetchagio/piko/issues/441)) ([c20e16f](https://github.com/chemchetchagio/piko/commit/c20e16f80499df75176e9080f156e529f4f7d326))
* **Bring back twitter:** Change x icon to legacy twitter. ([3006f47](https://github.com/chemchetchagio/piko/commit/3006f47d973ffde1622ae1544590a11e923c68ab))
* **Custom download folder:** Restore compatibility with versions prior to 10.64 ([b88b00b](https://github.com/chemchetchagio/piko/commit/b88b00ba97632d62517c0e52a924c453ea022d7a))
* **Custom downloader:** Improve fingerprint ([2a2a4a4](https://github.com/chemchetchagio/piko/commit/2a2a4a4e2cdc6587c5c3b91bb3888918d7cd720d))
* **Feature Flags:** Use ListView instead of RecyclerView for a more reliable list. ([6f16b7f](https://github.com/chemchetchagio/piko/commit/6f16b7f7d61c81e7a21394f74b6e0d0e80ed9a55))
* Fix crash when opening feature flags ([2b1484d](https://github.com/chemchetchagio/piko/commit/2b1484d6c291a997283d98358cff98b0195acfed))
* Improve getUsername fingerprint ([af617af](https://github.com/chemchetchagio/piko/commit/af617af523bfa7df00a232a51364ea9e8ea4d34f))
* Remove debug prints ([33e4d08](https://github.com/chemchetchagio/piko/commit/33e4d08a58451217781914953c1ffb711ea8480b))
* Remove duplicate strings ([94c6642](https://github.com/chemchetchagio/piko/commit/94c66422e0ced2cbdfd820dfee60cedd2c68e636))
* **Remove Google Ad:** Include ads in the comments ([79d6e35](https://github.com/chemchetchagio/piko/commit/79d6e35144ffc6c81d3bb36499fc2c22e5a089ac))
* Resource strings getting corrupted, resulting on failure to patch on revanced manager ([#439](https://github.com/chemchetchagio/piko/issues/439)) ([1763137](https://github.com/chemchetchagio/piko/commit/1763137126b9a95df51fe23ce816853ccf0a8f44))
* **Twitter:** `Customize Navigation Bar items` in/from `10.53.0-beta.1` ([e8154fb](https://github.com/chemchetchagio/piko/commit/e8154fb0ffa91e6d3ed2812bed3f71a034f3bc01))
* **Twitter:** Add support for version 10.64.0-beta.1 ([c81378d](https://github.com/chemchetchagio/piko/commit/c81378d80275465acbf9caed5f48235b56395d56))
* **Twitter:** Change patch name from `Enable app icon settings` -> `Enable app icons` ([5a7ef46](https://github.com/chemchetchagio/piko/commit/5a7ef469557e5cf4ecc9ce8465d73c20501dc524))
* **Twitter:** fix `Control video auto scroll` in 10.57 ([b7ae78c](https://github.com/chemchetchagio/piko/commit/b7ae78cd61b2f75d266e3fe3d57c5c21cd798e79))
* **Twitter:** fix `Enable app icon settings` patch ([c2b6f79](https://github.com/chemchetchagio/piko/commit/c2b6f79b5c833c2441432b2511374361318e5507))
* **Twitter:** Fix `Hide nudge button` patch ([d7572fe](https://github.com/chemchetchagio/piko/commit/d7572feac66d44f0fe669073ee09bc09637adb9a))
* **Twitter:** Fix `Remove premium upsell` patch ([4df5e32](https://github.com/chemchetchagio/piko/commit/4df5e32088eb57702c5f30e20b3c75d2ec11ee87))
* **Twitter:** fix `Remove videos for you` patch ([b19f943](https://github.com/chemchetchagio/piko/commit/b19f943ee8a19ea158e89cc031ae037e43da6e50))
* **Twitter:** Fix aapt breakage due to tag mismatch ([730a51c](https://github.com/chemchetchagio/piko/commit/730a51c20f464bbe2b680004721161dd5f34dadf))
* **Twitter:** fix video entity hook in `10.58` ([e8a833d](https://github.com/chemchetchagio/piko/commit/e8a833d2123b92a40caf68b4f6798e822a6d1737))
* **Twitter:** Missing download option in immersive view ([6b0aa2c](https://github.com/chemchetchagio/piko/commit/6b0aa2c0d8d0f9192630e42abef418a834a95df0))
* **Twitter:** Share menu button add hook in/from 10.67 ([a640946](https://github.com/chemchetchagio/piko/commit/a640946e7045be359535ed0eead00ec80d2e10c4))

### Features

* **all:** Added `Export all activities` patch from ReVanced ([7cc405f](https://github.com/chemchetchagio/piko/commit/7cc405f7e900b85aaa172e8693cd4ca2e790451d))
* **Bring back twitter:** Add Japanese ([4eb08b5](https://github.com/chemchetchagio/piko/commit/4eb08b554eaf92958e0e159647fc71b35340e2b2))
* **Customize side bar items:** Allow for hiding of the "Jobs" item ([14ce811](https://github.com/chemchetchagio/piko/commit/14ce811a7b4d885fa6779524aad0b41034a2d8d0))
* Enable recent patches by default ([e84f358](https://github.com/chemchetchagio/piko/commit/e84f358e494830fdecdc3dd12662b5f5ccd644b3))
* **Hook feature flag:** Added ability to search for supported flags. ([28a2c0a](https://github.com/chemchetchagio/piko/commit/28a2c0a6ca97fa50711ce44cfa1f20b5147e906f))
* Quick settings button is now optional ([e9e54e5](https://github.com/chemchetchagio/piko/commit/e9e54e5e44437b92db9700c363f0abd9117cc325))
* **Translations:** Updated Traditional Chinese string-zh-rCN.xml ([6cc2373](https://github.com/chemchetchagio/piko/commit/6cc2373e417a1ed386a2682f970662e367033b43))
* **Translations:** Updated Traditional Chinese string-zh-rTW.xml ([6787c28](https://github.com/chemchetchagio/piko/commit/6787c28318762382d73f1eb8c6ad9abc4b2ee2e6))
* **Twitter:** Added `Control video auto scroll` patch ([7a21924](https://github.com/chemchetchagio/piko/commit/7a21924dc7f30a15feef1797b0416c91de27d1e4))
* **Twitter:** Added `Custom downloader` ([3d5941e](https://github.com/chemchetchagio/piko/commit/3d5941e226c1fb9402edeeb138c1c974026e0598))
* **Twitter:** Added `Custom translator` patch ([737fb9e](https://github.com/chemchetchagio/piko/commit/737fb9eaa0b8da7f020b93c314f5da60f961e345))
* **Twitter:** Added `Customise post font size` patch ([ea608e0](https://github.com/chemchetchagio/piko/commit/ea608e09b7b0775f38ca1914503e1b54dc7b73f9))
* **Twitter:** Added `Customize explore tabs` patch ([4be6a7f](https://github.com/chemchetchagio/piko/commit/4be6a7fe6ace42ca299d2e4bc7f9a963774f3bcd))
* **Twitter:** Added `Customize reply sort filter` patch ([121b8a6](https://github.com/chemchetchagio/piko/commit/121b8a6e9345ea462ad9cb06f7b20f863fc08d4a))
* **Twitter:** Added `Customize search suggestions` patch ([aaca565](https://github.com/chemchetchagio/piko/commit/aaca565c650d6cf4b2cbb8abf2e206efe9983cb1))
* **Twitter:** Added `Customize search tab items` patch ([9edc97a](https://github.com/chemchetchagio/piko/commit/9edc97a89e61f28a5cd9a419d167a6c51a1a9816))
* **Twitter:** Added `Delete from database` patch ([d785660](https://github.com/chemchetchagio/piko/commit/d7856602786d3fb9d7a8721f05d80be97bc4fd3b))
* **Twitter:** Added `Enable force HD videos` patch ([d316612](https://github.com/chemchetchagio/piko/commit/d3166121ac39adf45440e6888b43487e398f61e6))
* **Twitter:** Added `Enable PiP mode automatically` patch ([59d6b67](https://github.com/chemchetchagio/piko/commit/59d6b6723cbff6fa96218fb6210e2cb0b8bc1338))
* **Twitter:** Added `Hide followed by context` patch ([261e1d0](https://github.com/chemchetchagio/piko/commit/261e1d0156702a4a72105b430d50e59e88795198))
* **Twitter:** Added `Hide nudge button` patch ([ad27484](https://github.com/chemchetchagio/piko/commit/ad27484f4cc0d727cf07cb4f202c8ddd6b582d67))
* **Twitter:** Added `Remove main event` patch ([806598d](https://github.com/chemchetchagio/piko/commit/806598d7154c538fb238f3d9b186746cb8c956bf))
* **Twitter:** Added `Remove premium upsell` patch ([37525de](https://github.com/chemchetchagio/piko/commit/37525de868c38254cbfd20b58d4fd077b0c14ca2))
* **Twitter:** Added `Remove top people in search` patch ([95b5ef9](https://github.com/chemchetchagio/piko/commit/95b5ef902e6f595093b2304e5b2a8189f273389c))
* **Twitter:** Added `Remove videos for you` patch ([25934a2](https://github.com/chemchetchagio/piko/commit/25934a2b58a8eefc05d4313b623580371d964a12))
* **Twitter:** Added Remember filter for `Customize reply sort filter` ([24df398](https://github.com/chemchetchagio/piko/commit/24df3987e5008aeca52c11a8b20714766cdafff1))
* **Twitter:** Added tab redirects hook (for Bookmark Navbar) ([f01b418](https://github.com/chemchetchagio/piko/commit/f01b418fcc13e9fe54d845eab3bea1cd62687f9f))
* **Twitter:** Custom deeplinks ([325a281](https://github.com/chemchetchagio/piko/commit/325a281225b1379b310d8ba14629bdbae0b314e5))

### Updates

* Add spanish to languages ([e9b8efd](https://github.com/chemchetchagio/piko/commit/e9b8efdb3570fa516f06a736f2709d1c166df1bf))
* Enable `Customize profile tabs` patch by default ([a8543bf](https://github.com/chemchetchagio/piko/commit/a8543bf0d2eebe8a1580870b95c75a890e845ff4))
* Enable `Hide Live Threads` patch by default ([b9862b5](https://github.com/chemchetchagio/piko/commit/b9862b50b97741721448c0ea667769b0024961c9))
* **Hook feature flag:** Improve flag matching in search. ([d7f0827](https://github.com/chemchetchagio/piko/commit/d7f0827218a9501a0b2e061990ce60a0af18ba0e))
* Improve quick settings appearance ([6dc27b4](https://github.com/chemchetchagio/piko/commit/6dc27b4a888d0028e455be1e1b41b83cdd7f7940))
* Improved the hooking of the recyclerview methods. also fixes the crash when opening feature flags. ([25e5bc4](https://github.com/chemchetchagio/piko/commit/25e5bc422c3893747b8fadd0744833a4ecb7b6ea))
* Russian translation ([42b68e9](https://github.com/chemchetchagio/piko/commit/42b68e96fccca505a60d6eb2682cbfb7f7acfb17))
* Translation updates ([509dfbb](https://github.com/chemchetchagio/piko/commit/509dfbb9e92511379406979a19b131a685229fc6))
* **Translations:** Translation updates ([4bf8a8d](https://github.com/chemchetchagio/piko/commit/4bf8a8dd954a7013a65ceee9d39521fd445d069d))
* **Translations:** Update `Japanese` ([b326d10](https://github.com/chemchetchagio/piko/commit/b326d10599db407e1e922ac8d6d2694a67c6e42b))
* **Translations:** Update translations ([9686863](https://github.com/chemchetchagio/piko/commit/968686390263fa700488deb5d87085470267c7cf))
* **Twitter:** Added hide 'Settings and privacy' in `Customize side bar items` ([cb01885](https://github.com/chemchetchagio/piko/commit/cb018852c8af8caaf4b986444208ab00a39eab41))
* **Twitter:** Added strings ([fad9b1a](https://github.com/chemchetchagio/piko/commit/fad9b1a9fd79b164c713fe35b61bad8ed3d9373b))
* **Twitter:** Change Quick Btn path ([7febdf6](https://github.com/chemchetchagio/piko/commit/7febdf612212ba61638fd818121c8cc4b9db8ed8))
* **Twitter:** Updated `Enable force HD videos` patch description ([86ea041](https://github.com/chemchetchagio/piko/commit/86ea0418d3606b6e04f8fbea8fc530aba5316f0f))
* **Twitter:** updated string ([60afc68](https://github.com/chemchetchagio/piko/commit/60afc683c4be02ba4d5cdc92879aad2e6755b14b))
* **Twitter:** Updated strings ([3cb159e](https://github.com/chemchetchagio/piko/commit/3cb159e57d66e22b7c2f638e5d0b7422a4ef2a10))

### Refactors

* **Custom Downloader:** Improve getting of tweet method declarations ([5237e49](https://github.com/chemchetchagio/piko/commit/5237e496140cc94fb9beb4a72057d927527dd78b))
* **Twitter:** Added 'Native features' section ([12d2bda](https://github.com/chemchetchagio/piko/commit/12d2bdaafd111eee81f22bdafa306c3493754c80))
* **Twitter:** Added Native download filename customization ([99a10b1](https://github.com/chemchetchagio/piko/commit/99a10b1615ffa3fb72df0ad283255e9c837a012f))
* **Twitter:** Added quick settings button in side drawer ([c0152e3](https://github.com/chemchetchagio/piko/commit/c0152e327e8b2e3fa2ad57d63c35738d4575cc98))
* **Twitter:** Added toggle for `Show sensitive media` patch ([cac4fe7](https://github.com/chemchetchagio/piko/commit/cac4fe747640e37dc9155c63f23082c44963c05d))
* **Twitter:** Change translator icon ([bf5f027](https://github.com/chemchetchagio/piko/commit/bf5f027f80507cf0db5b3dfd208d26b131987eca))
* **Twitter:** Changed `Top Articles ` string ([b590695](https://github.com/chemchetchagio/piko/commit/b5906957cb8cda07a40e02008b5ad69ad6389637))
* **Twitter:** Major string changes ([f22fdf0](https://github.com/chemchetchagio/piko/commit/f22fdf086184f71447d2696461d76914dbef731d))
* **Twitter:** More strings refactor ([d5a629f](https://github.com/chemchetchagio/piko/commit/d5a629f39bc4c15be1914a6ab98034129ed53f64))
* **Twitter:** refactor `Custom downloader` patch ([42cc752](https://github.com/chemchetchagio/piko/commit/42cc752c599f978f455f84ae9a917f7bb457af98))
* **Twitter:** Refactor `Custom downloader` patch ([1e966f7](https://github.com/chemchetchagio/piko/commit/1e966f7f519b7d947e0b516f8bc0ca0c55c1d623))
* **Twitter:** Refactor hooks filename ([2daa292](https://github.com/chemchetchagio/piko/commit/2daa2922c7225711fd1aa5d0556493e068026e0a))
* **Twitter:** refactor values of list preference ([e0e5c5b](https://github.com/chemchetchagio/piko/commit/e0e5c5b8639efcd5eecd6476bc59b7f125d5b851))
* **Twitter:** renamed 'Share menu button' fingerprints to hooks ([395c221](https://github.com/chemchetchagio/piko/commit/395c2217fc5f5b18cdc76568c3845140f76940d6))
* **Twitter:** Seperated/Added `Remove superhero event` patch ([d60ee17](https://github.com/chemchetchagio/piko/commit/d60ee17294b311bb964e3cc6200465218d7baca3))
* **Twitter:** Strings in 'Customization' ([c52c2c0](https://github.com/chemchetchagio/piko/commit/c52c2c01948bdea5593636a99502d8b5c6c41dca))
* **Twitter:** Strings in 'Customization' ([a75221b](https://github.com/chemchetchagio/piko/commit/a75221b80c1d3223b88890a95ca1610432defbe2))
* **Twitter:** Strings refactor ([2db8866](https://github.com/chemchetchagio/piko/commit/2db88663e70745ef81024d896ad5204c29b1ba06))

### Perfomance

* **Bring back twitter:** Optimize string replacement ([#440](https://github.com/chemchetchagio/piko/issues/440)) ([7e61023](https://github.com/chemchetchagio/piko/commit/7e6102351d9488f89489f87df2ec45d6d0d178d8))
